...
public class LoginfalidoTest {
  ...
  public void loginfalido() {
    ...
    assertThat(driver.findElement(By.id("login_error")).getText(), is("ERROR: The username or password you entered is incorrect. Lost your password?"));
  }
}
